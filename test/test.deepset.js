...
describe( 'deepset pdf', function tests() {
	...
	it( 'should compute the Gumbel pdf and deep set', function test() {
		var data, expected, i;
	...
	it( 'should return an empty array if provided an empty array', function test() {
		assert.deepEqual( pdf( [], mu, beta, 'x' ), [] );
		assert.deepEqual( pdf( [], mu, beta, 'x', '/' ), [] );
	});
